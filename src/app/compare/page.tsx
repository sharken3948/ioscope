...
function CompareRow({
  ...
  return (
    <tr style={{ borderBottom: '1px solid var(--border)' }}>
      ...
      <td className="py-3 px-4 text-center text-xs font-medium" style={{ color: 'var(--text-muted)' }}>
        {label}
      </td>
      <td className="py-3 px-4 text-center">
        <span
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            />
            <div className="flex items-center justify-center text-xl font-bold" style={{ color: 'var(--text-muted)' }}>
              vs
            </div>
            <AddressInput
              label="Address B"
          ...
          {bothReady && (
            ...
            >
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ borderBottom: '1px solid var(--border)' }}>
                    <th className="py-2 px-4 text-center font-medium text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <div className="grid md:grid-cols-2 gap-4 p-4 border-t" style={{ borderColor: 'var(--border)' }}>
                <div className="p-3 rounded-lg" style={{ background: 'var(--bg)' }}>
                  <div className="text-xs font-semibold mb-1.5" style={{ color: 'var(--text-muted)' }}>Address A — AI Summary</div>
                  <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>
                    {lD.aiAnalysis.explanation}
                  </p>
                </div>
                <div className="p-3 rounded-lg" style={{ background: 'var(--bg)' }}>
                  <div className="text-xs font-semibold mb-1.5" style={{ color: 'var(--text-muted)' }}>Address B — AI Summary</div>
                  <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>
