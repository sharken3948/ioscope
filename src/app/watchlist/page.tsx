...
const CHAINS: Chain[] = ['arc', 'base', 'soneium']
        ...
        <main className="flex-1 p-4 md:p-6">
          ...
          {entries.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-64 gap-3">
              ...
              <div className="text-sm" style={{ color: 'var(--text-muted)' }}>No addresses in watchlist yet</div>
              <button
                ...
                >
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <div className="text-center min-w-[40px]">
                      <div className="text-xs mb-0.5" style={{ color: 'var(--text-muted)' }}>Risk</div>
