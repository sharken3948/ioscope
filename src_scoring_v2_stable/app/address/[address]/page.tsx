...
function DashboardInner() {
  ...
  function handleDownload() {
    ...
    generateReport({
      ...
      uniqueInteractions: data.metrics.uniqueContracts,
      txFrequencyPerDay: data.metrics.txFrequencyPerDay,
      totalVolumeIn: data.metrics.totalVolumeIn,
      totalVolumeOut: data.metrics.tokenVolumeOut,
        ...
        >
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              {/* ENS name — shown large if available */}
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span
                  className="truncate max-w-[220px] sm:max-w-[380px] md:max-w-none"
                  style={{
                ...
                <span
                  className="flex items-center gap-1.5 text-xs px-2 py-0.5 rounded font-semibold shrink-0"
